...
root.students[1101] = Student([], 1101, "Mr. For Example", "1101")
...
root.students[1102] = Student([], 1102, "Mr. For Example", "1101")
root.students[1102].enrolls = [Enrollment(root.courses[101], 76.0, root.students[1101]), Enrollment(root.courses[201], 81.0, root.students[1101]), Enrollment(root.courses[202], 81.0, root.students[1101]),Enrollment(root.courses[301], 57.0, root.students[1101])]
