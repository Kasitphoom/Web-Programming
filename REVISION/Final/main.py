...
root.students[1102].enrolls = [Enrollment(root.courses[101], 76.0, root.students[1102]), Enrollment(root.courses[201], 81.0, root.students[1102]), Enrollment(root.courses[202], 81.0, root.students[1102]),Enrollment(root.courses[301], 57.0, root.students[1102])]
